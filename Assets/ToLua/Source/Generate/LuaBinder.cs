...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.BeginModule(null);
		ResourcesMgrWrap.Register(L);
		UUIEventListenerWrap.Register(L);
		LuaInterface_DebuggerWrap.Register(L);
		LuaProfilerWrap.Register(L);
		L.BeginModule("SUIFW");
		SUIFW_ABMgrWrap.Register(L);
		L.RegFunction("DelABLoadComplete", SUIFW_DelABLoadComplete);
		L.EndModule();
		...
		L.EndModule();
		L.BeginModule("UUIEventListener");
	...
	static int SUIFW_DelABLoadComplete(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<SUIFW.DelABLoadComplete>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<SUIFW.DelABLoadComplete>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
