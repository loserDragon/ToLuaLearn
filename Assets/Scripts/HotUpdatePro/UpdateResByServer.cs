...
public class UpdateResByServer : MonoBehaviour {
    ...
    //服务器地址
    private string serverUrl = "http://127.0.0.1:6080/UpdateAssets_ToLuaLearn/";
    ...
    private void Complete(string abName) {
        UnityEngine.Object obj = ABMgr.Instance().LoadAsset("mainscene", "mainscene/prefabs.ab", "UI_Notice.prefab", false);
        if (null == obj) {
            Debug.Log("null ");
        }
        else {
